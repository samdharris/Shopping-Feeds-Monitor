...
The Shopping Feeds Monitor was a re-write of an existing system that I undertook of my own accord during my internship at Evoluted during the summer of 2019. The purpose of this system was to enable Evoluted's marketing team to monitor and track how their ecommerce clients were selling their products. It watches for changes in a products price, availability plus if it's been added or removed from the feed.
